...
public class LobbyScript : LobbyBehavior {
	...
	void Update () {
		...
		//Debug.Log("Player 1 " + (players[0] = networkObject.player1));
        //Debug.Log("Player 2 " + (players[1] = networkObject.player2));
        //Debug.Log("Player 3 " + (players[2] = networkObject.player3));
        //Debug.Log("Player 4 " + (players[3] = networkObject.player4));

...
public class MonsterTruck : VehicleBase
{
    public override void Start()
    {
        ...
        InitWheelScale(fR_T.GetComponent<Transform>(), new Vector3(3.5f, 0.3f, 3.5f));
        fL_T = GameObject.FindWithTag("FL_Transform").GetComponent<Transform>();
        InitWheelScale(fL_T.GetComponent<Transform>(), new Vector3(3.5f, 0.3f, 3.5f));
        rR_T = GameObject.FindWithTag("RR_Transform").GetComponent<Transform>();
        InitWheelScale(rR_T.GetComponent<Transform>(), new Vector3(3.5f, 0.3f, 3.5f));
        rL_T = GameObject.FindWithTag("RL_Transform").GetComponent<Transform>();
        InitWheelScale(rL_T.GetComponent<Transform>(), new Vector3(3.5f, 0.3f, 3.5f));

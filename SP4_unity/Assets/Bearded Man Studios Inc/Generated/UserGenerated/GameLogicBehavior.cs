...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	{
		public const byte RPC_SEND_PLAYER_LIST = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("SendPlayerList", SendPlayerList, typeof(byte[]));
		...
		/// byte[] _playerList
		/// </summary>
		public abstract void SendPlayerList(RpcArgs args);

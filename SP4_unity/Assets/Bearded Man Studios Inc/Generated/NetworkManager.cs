...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] MachineGunNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			else if (obj is MachineGunNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (MachineGunNetworkObject.Length > 0 && MachineGunNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(MachineGunNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<MachineGunBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateMachineGun instead, its shorter and easier to type out ;)")]
		public MachineGunBehavior InstantiateMachineGunNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
